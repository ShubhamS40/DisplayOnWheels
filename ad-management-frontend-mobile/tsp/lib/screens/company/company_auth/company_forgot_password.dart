...
class ForgotPasswordCompanyScreen extends StatefulWidget {
  const ForgotPasswordCompanyScreen({super.key});

  @override
  _ForgotPasswordCompanyScreenState createState() => _ForgotPasswordCompanyScreenState();
}

class _ForgotPasswordCompanyScreenState extends State<ForgotPasswordCompanyScreen> {
